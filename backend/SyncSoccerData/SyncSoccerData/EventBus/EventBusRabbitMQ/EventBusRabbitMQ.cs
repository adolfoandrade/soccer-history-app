...
namespace SyncSoccerData.EventBus.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        {
            Log.Information("Subscribing to dynamic event {EventName} with {EventHandler}", eventName, typeof(TH).Name);
            ...
            where TH : IIntegrationEventHandler<T>
        {
            ...
            Log.Information("Subscribing to event {EventName} with {EventHandler}", eventName, typeof(TH).Name);
        ...
        private async Task Consumer_Received(object sender, BasicDeliverEventArgs eventArgs)
        {
            ...
            {
                Log.Warning(ex, "----- ERROR Processing message \"{Message}\"", message);
            }
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            {
                Log.Warning(ea.Exception, "Recreating RabbitMQ consumer channel");
        ...
        {
            Log.Warning("Processing RabbitMQ event: {EventName}", eventName);
            ...
            {
                Log.Warning("No subscription for RabbitMQ event: {EventName}", eventName);
            }
        }
    }
}
